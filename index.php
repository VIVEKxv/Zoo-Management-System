			...
			<div class="header-banner">
				<div class="container">
					<div class="head-banner">
						...
						<p style="color:white; font-size:120%;"><b>A zoo is another delightful place that can bring families together. 
							In addition, some animal species that are close to extinction can be saved too.Zoo is a place where we can see different animals and 
							birds at one place. It has great attraction particularly for the children.Zoos can provide fun and real educational scheme to children.
							 They’ll get to learn more about animals and nature too.</p>
					</div>
					<!-- <div >
